...
2. Le compilateur le transforme en [Bytecode](01.%20Architecture%20de%20Java.md#Bytecode) (`.class`)
3. La [JVM (Java Virtual Machine)](01.%20Architecture%20de%20Java.md#JVM%20(Java%20Virtual%20Machine)) exécute ce [Bytecode](01.%20Architecture%20de%20Java.md#Bytecode) sur le système d’exploitation
...
> [!info] Sans JVM, un programme Java ne peut pas fonctionner.
...
- `java` : lance la JVM  
- `-cp build` : indique le [Classpath](01.%20Architecture%20de%20Java.md#Classpath) (où se trouvent les fichiers `.class`)  
...
Java utilise un [Garbage Collector](01.%20Architecture%20de%20Java.md#Garbage%20Collector).
