...
> En Java : POJO/Entity, DAO, Service, Repository
...
> En Java Web : JSP, Thymeleaf, FreeMarker
...
[Requête HTTP] ──────────► Controller
                      ...
                      Données
                         │
                         ▼
                       View  ◄──── Controller (transmet les données)
                         │
                         ▼
...
## Implémentation Java EE (Servlet/JSP)
